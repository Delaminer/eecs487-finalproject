...
knn = NearestNeighbors(n_neighbors=k, metric='cosine', leaf_size=1000, algorithm="auto")
knn.fit(a)
test = [[2, 3, 4]]
results = knn.kneighbors(test, n_neighbors=k, return_distance=False).tolist()[0]
print(results)
